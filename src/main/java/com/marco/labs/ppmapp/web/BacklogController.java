...
import com.marco.labs.ppmapp.services.ProjectTaskService;
...
public class BacklogController {
	...
	public ResponseEntity<?>  getProjectTask(@PathVariable String backlog_id, @PathVariable String projectTask_id, Principal principal){
		ProjectTask projectTask = projectTaskService.findByProjectSequence(backlog_id, projectTask_id, principal.getName());
	...
	public ResponseEntity<?> deleteProjectTaskByProjectSequence(@PathVariable String backlog_id,  @PathVariable String projectTask_id, Principal principal){
